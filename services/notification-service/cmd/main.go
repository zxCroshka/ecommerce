...
import (
	...
	"github.com/zxCroshka/ecommerce/services/notification-service/internal/app"
...
func main() {
	...
	if err != nil {
		log.Error("failed to initialize Notification Service", "error", err)
		os.Exit(1)
	}
	if err := application.Start(ctx); err != nil {
		log.Error("Notification Service stopped with an error", "error", err)
		os.Exit(1)
	}
}
